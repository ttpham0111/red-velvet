...
def get_blueprint(app):
    ...
    @bp.route('/connections', frozenset({'GET'}))
    ...
    @bp.route('/connections/<connection_label>/keys', frozenset({'GET'}))
    ...
    @bp.route('/connections/<connection_label>/keys', frozenset({'POST'}))
    ...
    @bp.route('/connections/<connection_label>/keys/<key>', frozenset({'DELETE'}))
    ...
    @bp.route('/connections/<connection_label>/keys/<key>/values', frozenset({'GET'}))
    async def get_values(request, connection_label, key):
        ...
        # TODO: Handle binary data in JSON
        return response.json(value)

    @bp.route('/connections/<connection_label>/keys/<key>/values', frozenset({'POST'}))
    ...
    @bp.route('/connections/<connection_label>/keys/<key>/values/<value>', frozenset({'DELETE'}))
